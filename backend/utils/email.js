...
const sendEmail = async (to, templateName, data) => {
  try {
    ...
    const info = await transporter.sendMail({
      from: `"Ten&See" <${process.env.SMTP_USER || 'noreply@tenandsee.homes'}>`,
      to,
...
module.exports = {
  sendNewLeadAlert: (adminEmail, leadData) => sendEmail(adminEmail, 'newLead', leadData),
  sendStatusUpdate: (adminEmail, leadData) => sendEmail(adminEmail, 'leadStatusUpdate', leadData),
  sendChatAlert: (adminEmail, chatData) => sendEmail(adminEmail, 'newChatMessage', chatData),
  sendWeeklyReport: (adminEmail, reportData) => sendEmail(adminEmail, 'weeklyReport', reportData),
